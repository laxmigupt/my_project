		...
		<div class="wrap">
			<div class="metabox-holder">
				...
				<div class="pressbook-container">
					...
					<div class="pressbook-panel">
						<div class="pressbook-panel-content">
							<span class="pressbook-panel-title"><?php esc_html_e( 'Top & Primary Menu Color', 'pressbook' ); ?></span>
							<p class="description">
								<?php esc_html_e( 'You can change the background color of the top menu from the Customizer > Top Navbar. In the similar way, you can also change the background color of the primary menu from the Customizer > Primary Navbar.', 'pressbook' ); ?>
							</p>
						</div>
						<div class="pressbook-panel-actions">
							<a target="_blank" href="<?php echo esc_url( admin_url( 'customize.php' ) ); ?>" class="button"><?php esc_html_e( 'Theme Options', 'pressbook' ); ?></a>
					...
					<div class="pressbook-panel">
						...
						<div class="pressbook-panel-actions">
							<a target="_blank" href="<?php echo esc_url( admin_url( 'edit.php?post_type=wp_block' ) ); ?>" class="button"><?php esc_html_e( 'Reusable Blocks Manager', 'pressbook' ); ?></a>
						</div>
					</div>
					<div class="pressbook-panel">
						<div class="pressbook-panel-content">
					...
					<div class="pressbook-panel">
						<div class="pressbook-panel-content">
							...
							<p class="description">
								<?php esc_html_e( 'You can drag and drop widgets to the widget area. PressBook comes with 6 widgets area locations which include a left sidebar, right sidebar widgets area and 4 locations for footer widgets.', 'pressbook' ); ?>
							</p>
						</div>
						<div class="pressbook-panel-actions">
							<a target="_blank" href="<?php echo esc_url( admin_url( 'widgets.php' ) ); ?>" class="button"><?php esc_html_e( 'Widgets', 'pressbook' ); ?></a>
						</div>
					</div>
					<div class="pressbook-panel">
						<div class="pressbook-panel-content">
							<span class="pressbook-panel-title"><?php esc_html_e( 'Header / Body Background Color & Image', 'pressbook' ); ?></span>
							<p class="description">
					...
					<div class="pressbook-panel">
						<div class="pressbook-panel-content">
							...
							<p class="description">
								<?php esc_html_e( 'There are many page templates available to choose from. You can simply edit the page and on the right side of the page editor screen, set the template from "Page Attributes" > "Template" to "Page with sidebar".', 'pressbook' ); ?>
							</p>
							<p class="description">
